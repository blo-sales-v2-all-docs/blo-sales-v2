...
public final class ViewOrders extends AbstractDashboardBase {
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, pnlCtrlCloseOrderLayout.createSequentialGroup()
                        ...
                        .addGroup(pnlCtrlCloseOrderLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(pnlCtrlCloseOrderLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                ...
                                .addComponent(cmbxCloseOrderReasons, javax.swing.GroupLayout.Alignment.TRAILING, 0, 155, Short.MAX_VALUE))))
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, pnlCtrlCloseOrderLayout.createSequentialGroup()
    ...
    private void btnCloseOrderActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCloseOrderActionPerformed
       ...
       final boolean orderDelivered = reason.compareTo(StatusOrderProviderEnum.DELIVERED) == 0;
       if (orderDelivered) {
            new AddProductsInOrderDialog<String>(
                this,
        ...
        try {
            BloSalesV2Utils.validateRule(
                orderDelivered && info[0].equals(BloSalesV2Utils.JSON_EMPTY_ARRAY),
