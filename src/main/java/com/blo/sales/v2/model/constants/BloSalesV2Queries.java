...
public final class BloSalesV2Queries {
    ...
    /** creditos */
    public static final String INSERT_CREDIT_DEBIT = "INSERT INTO credits_debts(fk_user, lender_debtor_name, amount, payed, timestamp, payments, update_date, original_amount, type, available) VALUES(?, ?, ?, ?, ?, ?, ?, ?, ?, true)";
    
    public static final String UPDATE_CREDIT_DEBIT = "UPDATE credits_debts SET lender_debtor_name = ?, payed = ?, timestamp = ?, payments = ?, available = ?, update_date = ?, amount = ? WHERE id_credit_debt = ?";
    
    public static final String SELECT_CREDIT_DEBIT_BY_ID = "SELECT id_credit_debt, fk_user, lender_debtor_name, amount, payed, timestamp, payments, available, update_date, type FROM credits_debts WHERE id_credit_debt = ? LIMIT 1";
    
    public static final String SELECT_CREDITS_DEBITS = "SELECT id_credit_debt, fk_user, lender_debtor_name, amount, payed, timestamp, payments, available, update_date, original_amount, type FROM credits_debts WHERE type = ?";
}
