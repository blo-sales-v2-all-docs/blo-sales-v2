...
public final class BloSalesV2Queries {
    ...
    /** creditos */
    public static final String INSERT_CREDIT = "INSERT INTO credits(fk_user, lender_name, amount, payed, timestamp, payments, update_date, original_amount, available) VALUES(?, ?, ?, ?, ?, ?, ?, ?, true)";
    ...
    public static final String SELECT_CREDITS = "SELECT id_credit, fk_user, lender_name, amount, payed, timestamp, payments, available, update_date, original_amount FROM credits";
}
